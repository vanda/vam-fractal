module.exports = {
  ...
  context: {
    ...
    heading: 'The V&A Research Institute is a five-year programme of projects and partnerships',
    ctaLabel: 'View all',
    carouselItems: [
      {
        title: '#1 Featured content heading',
        description: 'Description of featured content',
        url: 'https://www.vam.ac.uk/test-1',
        image: {
      ...
      {
        title: '#2 Featured content heading',
        description: 'Description of featured content',
        url: 'https://www.vam.ac.uk/test-2',
        image: {
      ...
      {
        title: '#3 Featured content heading',
        description: 'Description of featured content',
        url: 'https://www.vam.ac.uk/test-3',
        image: {
