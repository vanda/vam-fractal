...
module.exports = {
  ...
  context: {
    objectShufflerData: [
      {
        title: 'Posters',
        feed: 'http://vam-etc-test-api.azureedge.net/api/v2/objects/search?profile=ymal&q=poster',
        data: [
        ]
      },
      {
        title: 'Netsuke',
        feed: 'http://vam-etc-test-api.azureedge.net/api/v2/objects/search?profile=ymal&q_object_type=netsuke',
        data: [
        ]
      },
      {
        title: 'Lego',
        feed: 'http://vam-etc-test-api.azureedge.net/api/v2/objects/search?profile=ymal&q=lego',
        data: [
        ]
      },
      {
        title: 'Bikes',
        feed: 'http://vam-etc-test-api.azureedge.net/api/v2/objects/search?profile=ymal&q=bicycle',
        data: [
        ]
      }
    ]
