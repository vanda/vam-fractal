module.exports = {
  ...
  default: '5 events default',
  context: {
    title: 'Featured event items',
    items: [
      {
        image: {
        ...
        type: 'Exhibition',
        title: 'Raphael Cartoon, The Miraculous Draught of Fishes: Luke Chapter 5: Verses 1 to 11',
        url: 'https://www.vam.ac.uk/test-01',
      ...
      },
      {
        ...
        type: 'Display',
        title: 'Lego bits and pieces',
        url: 'https://www.vam.ac.uk/test-02',
        date: 'On now until Wednesday, 8 March 2023',
        venue: 'Young V&A'
      },
      {
        image: {
        ...
        url: 'https://www.vam.ac.uk/test-03',
        date: 'Thursday, 27 October 2022 – Sunday, 13 August 2023',
        venue: 'V&A South Kensington'
      },
      {
        image: {
          ...
          960: 'https://vanda-production-assets.s3.amazonaws.com/2016/04/29/10/52/00/85ca285a-f4c9-446a-8a55-ab2065f81133/Blue-glass-form-2560.jpg',
          1280: 'https://vanda-production-assets.s3.amazonaws.com/2016/04/29/10/52/00/abe97dab-83fc-4633-8e80-5b04f6a82d9d/Blue-glass-form-2560.jpg'
        },
        type: 'Talk',
        title: 'Lovely blue glass object',
        url: 'https://www.vam.ac.uk/test-04',
        date: 'Every Saturday',
      ...
      },
      {
        ...
        title: 'Fruit, insects and birds',
        url: 'https://www.vam.ac.uk/test-05',
        date: 'On now until Sunday, 16 April 2023',
        venue: 'Online'
      }
    ]
  ...
  variants: [
    {
      name: '1 event',
      label: '1 event',
      previewClass: 'b-events-featured--test-one',
      context: {
        modifiers: ['featured-one'],
        items: [
          {
            image: {
              320: 'https://framemark.vam.ac.uk/collections/2020MP2543/full/320,/0/default.jpg',
    ...
    },
    {
      name: '2 events',
      label: '2 events',
      previewClass: 'b-events-featured--test-two',
      context: {
        modifiers: ['featured-two'],
        items: [
          {
            image: {
              320: 'https://framemark.vam.ac.uk/collections/2020MP2543/full/320,/0/default.jpg',
    ...
    },
    {
      name: '3 events',
      label: '3 events',
      previewClass: 'b-events-featured--test-three',
      context: {
        modifiers: ['featured-three'],
        items: [
          {
            image: {
              320: 'https://framemark.vam.ac.uk/collections/2020MP2543/full/320,/0/default.jpg',
    ...
    },
    {
      name: '4 events',
      label: '4 events',
      previewClass: 'b-events-featured--test-four',
      context: {
        modifiers: ['featured-four'],
        items: [
          {
            image: {
              320: 'https://framemark.vam.ac.uk/collections/2020MP2543/full/320,/0/default.jpg',
